#### Meadows Paper ####
## Function: Estimates a basic Mixed Logit model with full sample
...
apollo_control = list(
  nCores    = 10,
  mixing    = TRUE,
  modelDescr = "Meadows_MXL_Levels_FullSample_2022_03_24",
  modelName  = "Meadows_MXL_Levels_FullSample_2022_03_24",
  indivID    = "ID"
)
...
Meadows_MXL_Levels_FullSample_2022_03_24 = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)

## Model output and results here alongside saving information
apollo_modelOutput(Meadows_MXL_Levels_FullSample_2022_03_24,modelOutput_settings = list(printPVal=TRUE))
apollo_saveOutput(Meadows_MXL_Levels_FullSample_2022_03_24,saveOutput_settings = list(printPVal=TRUE))
saveRDS(Meadows_MXL_Levels_FullSample_2022_03_24, file="Meadows_MXL_Levels_FullSample_2022_03_24.rds")


Model <- readRDS("Meadows_MXL_Levels_FullSample_2022_03_24.rds") ## Enter model of interest RDS here
...
write.csv(Meadows_ConditionalWTP,"Meadows_MXL_Levels_FullSample_2022_03_24_WTP.csv")
Meadows_ConditionalWTP <- data.frame(read.csv("Meadows_MXL_Levels_FullSample_2022_03_24_WTP.csv"))
...
ggsave(melt(Meadows_ConditionalWTPSummary) %>% ggplot(aes(x=value,y=variable,group=variable,fill=variable))+
       ...
       device = "jpeg",
       filename = "Meadows_ConditionalWTPSummary_2022_03_24.jpeg",
